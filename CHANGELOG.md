...
### Added
- **handoff:** preserve context and verify completion across agents (`4760f7b`)

### Documentation
- update changelog for 2.3.0 (`90d71c8`)

## [2.3.0] - 2026-09-15

### Added
- **save,resume,finish:** add Parked section so handoffs get an end point (`88a694a`)

### Documentation
- update changelog for 2.2.1 (`8aedc65`)
